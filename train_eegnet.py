...
# ---- Load data prepared by prepare_data.py (75/15/10 subject-wise split) ----
...
EPOCHS = 60
PATIENCE = 12
CKPT_EVERY = 5   # save a checkpoint every 5 epochs, per mentor request
...
for epoch in range(1, EPOCHS + 1):
    ...
    # periodic checkpoint save (every CKPT_EVERY epochs)
...
# ---- Load BEST-ON-VAL checkpoint, evaluate on test set exactly ONCE ----
